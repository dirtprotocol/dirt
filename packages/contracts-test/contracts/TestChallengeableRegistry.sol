...
contract TestChallengeableRegistry is ChallengeableRegistry, Reset {
    ...
    function getPollId(string memory _key) public view returns (uint) {
        return challenges[_key].voteId;
    }

    function expireChallenge(string memory _key) public returns (bool success) {
